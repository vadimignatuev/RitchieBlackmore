$(document).ready(function () {
    ...
    $("#jqg").jqGrid({
        ...
        viewrecords: true,
        editurl: "Products/GetProductsList",
...
function status_button_maker_v3(rowId, options, rowObject) {
    return "<button class=\"ver3_statusbutton\" onclick=\"motionProduct(" + options.rowId + ")\">" + "Движение товара</button>" +
           "<button class=\"ver3_statusbutton\">" + "Редактировать" + "</button>" +
